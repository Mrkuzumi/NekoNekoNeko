...
> [!CAUTION]
># 全程电脑插着网线连接路由器LAN口，在刷完固件之后，请先把路由器的WAN口（浏览器进入192.168.1.1路由器后台）和电脑设置”网络偏好设置”的“以太网”的“属性”设为静态ip，将参数和你提前先用电脑连接sztu校园网的参数一样，注意路由器WAN口设置的子网掩码需要根据校园网给你分配的ip地址进行计算，具体换算为
## 假如我的ip地址为x.x.x.x/23
